from PyQt5.QtWidgets import (
    ...
    QSlider, QSpinBox, QCheckBox, QColorDialog, QGroupBox, QGridLayout
)
...
class SettingsDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        self.sld_alpha.setRange(30, 255)
        self.sld_alpha.setValue(self.cfg.get("bg_alpha", 210))
        self.lbl_alpha = QLabel(str(self.cfg.get("bg_alpha", 210)))
        self.sld_alpha.valueChanged.connect(lambda v: self.lbl_alpha.setText(str(v)))
        row_a = QHBoxLayout()
    ...
    def _save_and_close(self):
        ...
        self.cfg["bg_alpha"]         = self.sld_alpha.value()
